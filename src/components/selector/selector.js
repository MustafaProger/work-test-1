...
class Selector extends Component {
  ...
  handleOutsideClick = (event) => {
    ...
    if (isOpen && this.selectorRef && !this.selectorRef.contains(event.target)) {
